...
pub struct SocialRecoveryState {
    ...
    recovery_session_decryption_key:
        SerdeEncodable<threshold_crypto::serde_impl::SerdeSecret<threshold_crypto::SecretKey>>,
    shares: BTreeMap<PeerId, SerdeEncodable<threshold_crypto::DecryptionShare>>,
}
...
impl SocialRecovery {
    ...
    pub async fn upload_verification_request(
        ...
        self.context
            .api
            .social_recovery(self.module_id, req)
            .await?;
        Ok(())
    }
...
impl SocialVerification {
    pub fn new(module_id: ModuleInstanceId, context: Arc<ClientContext>, peer_id: PeerId) -> Self {
        Self {
            context,
            peer_id,
            module_id,
