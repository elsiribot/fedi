...
[`fedi`] library. The Swift language bindings are created by the [`fedi-ffi`] project which is included as a module of this repository. 

## How to Use

To use the Swift language bindings for [`fedi`] in your [Xcode] iOS or MacOS project add 
the github repository (https://github.com/uniffi-bindings-template/Fedi) and select one of the 
release versions. You may then import and use the `Fedi` library in your Swift 
code. For example:
