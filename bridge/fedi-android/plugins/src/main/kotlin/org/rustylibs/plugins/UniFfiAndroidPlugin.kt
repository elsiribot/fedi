...
internal class UniFfiAndroidPlugin : Plugin<Project> {
    override fun apply(target: Project): Unit = target.run {
        ...
        val buildAndroidAarch64Binary by tasks.register<Exec>("buildAndroidAarch64Binary") {
            ...
            workingDir("${projectDir}/../../fedi-ffi")
            ...
            doLast {
                println("Native library for fedi-android on aarch64 built successfully")
            }
        }
        ...
        val buildAndroidX86_64Binary by tasks.register<Exec>("buildAndroidX86_64Binary") {
            ...
            workingDir("${project.projectDir}/../../fedi-ffi")
            val cargoArgs: MutableList<String> =
            ...
            doLast {
                println("Native library for fedi-android on x86_64 built successfully")
            }
        }
        ...
        val buildAndroidArmv7Binary by tasks.register<Exec>("buildAndroidArmv7Binary") {
            ...
            doLast {
                println("Native library for fedi-android on armv7 built successfully")
            }
        }

        // move the native libs build by cargo from fedi-ffi/target/<architecture>/release/
        // to their place in the fedi-android library
        ...
        val generateAndroidBindings by tasks.register<Exec>("generateAndroidBindings") {
            ...
            args(
                ...
                "kotlin",
                "--out-dir",
                "../fedi-android/lib/src/main/kotlin"
            )
