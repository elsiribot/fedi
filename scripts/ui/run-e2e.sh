...
export RUN_TESTS=1
available_tests=("onboarding" "settings" "JoinLeaveFederation" "chat" "communityChatJoin" "payments" "onchainSend" "backupRestore" "pinProtection")
...
while true; do
  ...
  case $input in
    ...
    p)
      ...
      ;;
    h)
      TESTS_TO_RUN="onchainSend"
      echo "Selected test: onchainSend"
      break
      ;;
    b)
