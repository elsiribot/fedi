...
When set, new members who scan the federation invite will be able to preview the federation information, but they will not be able to join. You can use this together with [`invite_codes_disabled`](invite_codes_disabled.md) to reduce the virality of this federation.
...
```json
"new_members_disabled": "true" // defaults to "false"
```
