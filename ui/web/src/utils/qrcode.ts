 ...
 */
export function renderStyledQrSvg(qrData: QRCode) {
    ...
    const qrSvg = `
        ...
        >
            ...
            <g transform="translate(0,0)">
                ${renderQrDots(data, size, moduleSize)}
...
`
    ...
    const svg = `
        ...
        >
            <defs>
                <g id="qr" style="color: inherit">${qrSvg}</g>
            </defs>
...
function renderQrDots(data: Uint8Array, size: number, moduleSize: number) {
    let svg = ''
