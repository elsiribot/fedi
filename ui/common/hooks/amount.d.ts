 ...
 */
export declare function useMinMaxSendAmount({ invoice, lnurlPayment, }?: SendAmountArgs): {
    minimumAmount: Sats;
    maximumAmount: Sats;
};
/**
 ...
 */
export declare function useSendForm({ btcAddress, bip21Payment, invoice, lnurlPayment, }?: SendAmountArgs): {
    inputAmount: Sats;
    setInputAmount: import("react").Dispatch<import("react").SetStateAction<Sats>>;
