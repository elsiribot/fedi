...
import { Invoice, MSats, ParsedBip21, ParsedBitcoinAddress, ParsedLnurlPay, ParsedLnurlWithdraw, Sats, SupportedCurrency, UsdCents } from '../types';
 ...
 */
export declare function useMinMaxSendAmount({ invoice, lnurlPayment, selectedPaymentFederation, }?: SendAmountArgs): {
    minimumAmount: Sats;
    maximumAmount: Sats;
};
/**
 ...
 */
export declare function useSendForm({ btcAddress, bip21Payment, invoice, lnurlPayment, selectedPaymentFederation, }?: SendAmountArgs): {
    inputAmount: Sats;
    setInputAmount: import("react").Dispatch<import("react").SetStateAction<Sats>>;
