...
/** @deprecated XMPP legacy code */
export declare const selectChatConnectionOptions: ((state: CommonState) => import("../types").XmppConnectionOptions | null) & import("reselect").OutputSelectorFields<(args_0: import("../types").ClientConfigMetadata) => import("../types").XmppConnectionOptions & {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
...
/** @deprecated XMPP legacy code */
export declare const selectChatDefaultGroupIds: ((state: CommonState) => string[]) & import("reselect").OutputSelectorFields<(args_0: import("../types").FederationListItem | undefined) => string[] & {
    clearCache: () => void;
}> & {
    clearCache: () => void;
};
