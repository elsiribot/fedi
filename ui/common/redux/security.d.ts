...
/*** Selectors ***/
export declare const selectIsFeatureUnlocked: (s: CommonState, feature: keyof ProtectedFeatures) => any;
export declare const selectProtectedFeatures: (s: CommonState) => any;
export declare const selectIsRecoveringBeforePin: (s: CommonState) => any;
