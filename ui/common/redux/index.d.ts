...
export declare const commonReducers: {
    ...
    federation: import("redux").Reducer<{
        federations: import("../types").FederationListItem[];
        ...
        externalMeta: Record<string, import("../types").ClientConfigMetadata | undefined>;
        customFediMods: Record<string, import("../types").FediMod[] | undefined>;
        defaultCommunityChats: Record<string, import("../types").MatrixRoom[]>;
    }>;
    matrix: import("redux").Reducer<{
        ...
        errors: Error[];
        pushNotificationToken: string | null;
        groupPreviews: Record<string, import("../types").MatrixGroupPreview>;
    }>;
    mod: import("redux").Reducer<{
        customGlobalMods: Record<string, import("../types").FediMod>;
        customGlobalModVisibility: Record<string, import("./mod").ModVisibility>;
        suggestedGlobalModVisibility: Record<string, import("./mod").ModVisibility>;
    }>;
