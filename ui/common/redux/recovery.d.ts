...
export declare const approveSocialRecoveryRequest: import("@reduxjs/toolkit").AsyncThunk<void, {
    fedimint: FedimintBridge;
    recoveryId: string;
    peerId: number;
    password: string;
...
export declare const locateRecoveryFile: import("@reduxjs/toolkit").AsyncThunk<string, FedimintBridge, {
    state?: unknown;
    dispatch?: import("redux").Dispatch;
    extra?: unknown;
    rejectValue?: unknown;
...
export declare const socialRecoveryDownloadVerificationDoc: import("@reduxjs/toolkit").AsyncThunk<void, {
    fedimint: FedimintBridge;
    recoveryId: string;
    peerId: number;
    federationId: string;
...
export declare const uploadBackupFile: import("@reduxjs/toolkit").AsyncThunk<void, {
    fedimint: FedimintBridge;
    federationId: string;
