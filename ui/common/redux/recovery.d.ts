...
/*** Basic actions ***/
export declare const setSocialRecoveryState: import("@reduxjs/toolkit").ActionCreatorWithPayload<SocialRecoveryEvent | null, "recovery/setSocialRecoveryState">, setDeviceIndexRequired: import("@reduxjs/toolkit").ActionCreatorWithPayload<boolean, "recovery/setDeviceIndexRequired">;
/*** Async thunk actions ***/
