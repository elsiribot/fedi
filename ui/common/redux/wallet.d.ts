...
export declare const selectStableBalanceSats: ((state: CommonState) => import("../types").Sats) & import("reselect").OutputSelectorFields<(args_0: UsdCents, args_1: number) => number & {
    _: "Sats";
} & {
    clearCache: () => void;
}> & {
