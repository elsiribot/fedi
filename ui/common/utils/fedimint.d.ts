...
export declare class FedimintBridge {
    ...
    getAccruedOutstandingFediFees(args: bindings.RpcPayload<'getAccruedOutstandingFediFees'>): Promise<MSats>;
    getAccruedPendingFediFees(args: bindings.RpcPayload<'getAccruedPendingFediFees'>): Promise<MSats>;
    /*** BRIDGE EVENTS ***/
    private listeners;
