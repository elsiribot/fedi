...
import { ErrorCode, RpcAmount } from '../types/bindings';
export declare class FedimintBridge {
    ...
    bridgeStatus(): Promise<{
        matrixSetup: boolean;
        deviceIndexAssignmentStatus: bindings.RpcDeviceIndexAssignmentStatus;
    }>;
    ...
    decodeInvoice(invoice: string, federationId?: string | null): Promise<{
        paymentHash: string;
        amount: MSats;
    ...
    signLnurlMessage(message: string, domain: string): Promise<{
        signature: string;
        pubkey: string;
    }>;
    ...
    transferExistingDeviceRegistration(index: number): Promise<{
        balance: MSats;
        id: string;
        network: string | null;
        name: string;
    ...
    deviceIndexAssignmentStatus(): Promise<{
        assigned: number;
    } | "unassigned">;
    fetchRegisteredDevices(): Promise<{
        deviceIndex: number;
        deviceIdentifier: string;
        lastRegistrationTimestamp: number;
    }[]>;
    ...
    matrixGetAccountSession(args: bindings.RpcPayload<'matrixGetAccountSession'>): Promise<{
        userId: string;
        deviceId: string;
        displayName: string | null;
        avatarUrl: string | null;
    }>;
    matrixPublicRoomInfo(args: bindings.RpcPayload<'matrixPublicRoomInfo'>): Promise<any>;
    matrixRoomPreviewContent(args: bindings.RpcPayload<'matrixRoomPreviewContent'>): Promise<({
        kind: "event";
        value: bindings.RpcTimelineItemEvent;
    } | {
        kind: "dayDivider";
        value: number;
    } | {
    ...
    matrixUserProfile(args: bindings.RpcPayload<'matrixUserProfile'>): Promise<any>;
    ...
    matrixRoomGetNotificationMode(args: bindings.RpcPayload<'matrixRoomGetNotificationMode'>): Promise<"allMessages" | "mentionsAndKeywordsOnly" | "mute" | null>;
    ...
    getAccruedOutstandingFediFeesPerTXType(args: bindings.RpcPayload<'getAccruedOutstandingFediFeesPerTXType'>): Promise<[string, "receive" | "send", MSats][]>;
    getAccruedPendingFediFeesPerTXType(args: bindings.RpcPayload<'getAccruedPendingFediFeesPerTXType'>): Promise<[string, "receive" | "send", MSats][]>;
    /*** COMMUNITIES RPCs ***/
    communityPreview(args: bindings.RpcPayload<'communityPreview'>): Promise<{
        inviteCode: string;
        name: string;
        version: number;
        meta: Record<string, string>;
    }>;
    joinCommunity(args: bindings.RpcPayload<'joinCommunity'>): Promise<{
        inviteCode: string;
        name: string;
        version: number;
        meta: Record<string, string>;
    ...
    listCommunities(args: bindings.RpcPayload<'listCommunities'>): Promise<{
        inviteCode: string;
        name: string;
        version: number;
        meta: Record<string, string>;
