...
import { MSats, MatrixEvent, MatrixPaymentEvent, MatrixPaymentStatus, MatrixRoomPowerLevels, MatrixTimelineItem, MatrixUser } from '../types';
...
export declare function getReceivablePaymentEvents(timeline: MatrixTimelineItem[], myId: string, myFederations: RpcFederation[]): MatrixPaymentEvent[];
export declare function encodeFediMatrixUserUri(id: string): string;
export declare function encodeFediMatrixRoomUri(id: string): string;
