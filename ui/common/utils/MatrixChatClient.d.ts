import { MatrixRoom, MatrixUser, MatrixError, MatrixRoomMember, MatrixSearchResults, MatrixAuth, MatrixCreateRoomOptions, MatrixTimelineObservableUpdates, MatrixRoomListObservableUpdates, MatrixTimelineItem, MatrixRoomPowerLevels, MatrixSyncStatus } from '../types';
...
export declare class MatrixChatClient {
    ...
    fetchMatrixProfile(userId: MatrixUser['id']): Promise<{
        displayname: string;
    }>;
