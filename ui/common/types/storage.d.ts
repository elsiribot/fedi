...
export interface StoredStateV2 extends Omit<StoredStateV1, 'version' | 'chatIdentities'> {
    version: 2;
    chat: Record<Federation['id'], {
...
export interface StoredStateV8 extends Omit<StoredStateV7, 'version' | 'btcExchangeRates'> {
    version: 8;
    btcUsdRate: number;
...
export interface StoredStateV14 extends Omit<StoredStateV13, 'version' | 'chat'> {
    version: 14;
    chat: Record<Federation['id'], {
        authenticatedMember: ChatMember | null;
        messages: ChatMessage[];
...
export interface StoredStateV19 extends Omit<StoredStateV18, 'version' | 'customGlobalModVisibility' | 'suggestedGlobalModVisibility'> {
    version: 19;
    modVisibility: Record<FediMod['id'], ModVisibility>;
}
export interface StoredStateV20 extends Omit<StoredStateV19, 'version'> {
    version: 20;
    protectedFeatures: Pick<ProtectedFeatures, 'app' | 'changePin' | 'nostrSettings'>;
}
export interface StoredStateV21 extends Omit<StoredStateV20, 'version' | 'chat'> {
    version: 21;
}
...
export type AnyStoredState = StoredStateV0 | StoredStateV1 | StoredStateV2 | StoredStateV3 | StoredStateV4 | StoredStateV5 | StoredStateV6 | StoredStateV7 | StoredStateV8 | StoredStateV9 | StoredStateV10 | StoredStateV11 | StoredStateV12 | StoredStateV13 | StoredStateV14 | StoredStateV15 | StoredStateV16 | StoredStateV17 | StoredStateV18 | StoredStateV19 | StoredStateV20 | StoredStateV21 | StoredStateV22;
