...
export function wasm_bindgen__convert__closures__invoke1_mut__hbe4cb41a0484a6fd(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h86054b4b9015b4fc(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h62cb98f7787681a9(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h0cf2497c2ed66e74(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h4a628ebbc44de212(a: number, b: number): void;
