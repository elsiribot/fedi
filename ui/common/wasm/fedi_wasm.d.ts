...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__hb7980122161155c8: (a: number, b: number, c: number, d: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h0751d041da87eae3: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hd92472798f6590ce: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h0a7f6f3bc16f6768: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__hc31d0cdac305de3e: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__hcd844202aa5904c1: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h739dd69c60e8d2be: (a: number, b: number) => void;
  readonly __wbindgen_free: (a: number, b: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__h8d021fcefbe45496: (a: number, b: number, c: number, d: number) => void;
}
